      ...
      .then((response) => {
        ...
        urevitedAPI
          ...
          .then((response) => {
            ...
            const createdVenue = listOfVenues.find(
        ...
        urevitedAPI
          ...
          .then((response) => {
            ...
            urevitedAPI
              ...
              .then((response) => {
                expect(response.body.data.venues.items[0].name).equal(
                  editedVenueName
                );
              });
          });
            ...
            urevitedAPI
              ...
              .then((response) => {
                ...
                urevitedAPI
                  ...
                  .then((response) => {
                    expect(response.body.data.venues.totalCount).equal(
                      numberOfVenuesBefore
                    );
                  });
              });
          });
